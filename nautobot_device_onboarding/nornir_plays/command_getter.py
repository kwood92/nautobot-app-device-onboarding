...
from nautobot_device_onboarding.constants import SUPPORTED_COMMAND_PARSERS#, SUPPORTED_NETWORK_DRIVERS - Fix startup crash https://github.com/nautobot/nautobot-app-device-onboarding/issues/320
...
def netmiko_send_commands(
    ...
    #if task.host.platform not in SUPPORTED_NETWORK_DRIVERS or not "cisco_wlc_ssh": - Fix startup crash https://github.com/nautobot/nautobot-app-device-onboarding/issues/320
            ...
            inventory={
                ...
                "options": {
                    ...
                    "defaults": {
                        ...
                        "network_driver_mappings": list(get_all_network_driver_mappings().keys()),#SUPPORTED_NETWORK_DRIVERS, - Fix startup crash https://github.com/nautobot/nautobot-app-device-onboarding/issues/320
